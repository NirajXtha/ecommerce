...
<div id="carouselBlk">
	<div id="myCarousel" class="carousel slide" >
		<div class="carousel-inner">
		  ...
		  <div class="container">
			<img className='imgCarosule' style="width:100%; height:315px" src="images/carousel/1.jpg" alt=""/>
...
<a href="product.php?id=<?php echo $row10['product_id']?>"> <div class="product">
	...
	<h5 class="title"><?php echo $row10['product_title'] ?> </h5>
	<p class="description"><?php echo $row10['product_desc'] ?>  
	<p class="price"><b>Rs.<?php echo $row10['product_price'] ?></b><br>
