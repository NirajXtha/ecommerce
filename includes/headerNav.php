...
if (session_status() !== PHP_SESSION_ACTIVE) {
 ...
 $_SESSION['web-name'] = 'GadgetGhar'; // Change to your desired website name
$_SESSION['web-img'] = '../upload/logo.png';
...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
   ...
   <form id="myForm" style='margin-right:4px; width: 60%;' class="form-inline navbar-search" method="post" action="./search.php"  >
	  <div class="input-group col-md-4" style="width:100%">
            <input class="form-control py-2 border-right-0 border search-btn" style="width:100%" type="search" name='search' id='transcript' placeholder="search" >
            <!-- <span class="input-group-append" >
              <button class="btn btn-info border-left-0 border btn-large btn-custom" style=""  name='submit' type="submit">
    ...
    <ul id="topMenu" class="nav pull-right">
	 ...
	 <li class="" style="opacity:1"><a href="#?loginfirst">profile</a></li> <?php }?>
...
<?php echo $_SESSION['cartItemNum'] ?>
	...
	<div id="login" style="background-color: #cdcdcd" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
		  ...
		  <div class="modal-body">
			<form class="form-horizontal loginFrm" action="<?php echo $_SERVER['PHP_SELF']?> " method="post">
			  <div class="control-group">								
				<input type="text" id="inputEmail" name="email" placeholder="Email" class="login-inp">
			  </div>
			  <div class="control-group">
				<input type="password" id="inputPassword" name="pwd" placeholder="Password" class="login-inp">
			  </div>
			  <div class="control-group">
